        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button onClick={saveNewUser} className="btn btn-success text-black">
                Create Account
              </button>
            </div>
          </div>
      ...
      >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <div className="mb-3">
                <label htmlFor="loginEmail" className="form-label text-black">
                  Email Id
                </label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label htmlFor="login-password" className="form-label text-black">
                  Password
                </label>
                <input
                  type="password"
            ...
            <div className="modal-footer">
              <button onClick={userLogin} className="btn btn-success text-black">
                Login
              </button>
            </div>
          </div>
